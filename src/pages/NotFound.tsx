    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-6">
        <div className="relative w-24 h-24 mx-auto">
          ...
          <Flag className="absolute inset-0 m-auto h-12 w-12 text-f1-red" />
        </div>
        <h1 className="text-6xl font-bold text-f1-red">404</h1>
        <p className="text-xl mb-6">Oops! Looks like you took a detour off the track.</p>
        <Link to="/">
          <Button className="bg-f1-red hover:bg-f1-red/90">
